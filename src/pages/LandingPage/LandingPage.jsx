    ...
    <main>
        ...
        <div className="details__inner-container">
          ...
          <div className="details__card-container">
            <div className="details__card">
              ...
              <div className="details__card-content">
                <h2 className="header header--secondary">
                  <span className="body body--display details__number">1.</span> Find a group
                </h2>
            ...
            <div className="details__card">
              ...
              <div className="details__card-content">
                <h2 className="header header--secondary">
                  <span className="body body--display details__number">2.</span> Learn a Topic
                </h2>
            ...
            <div className="details__card">
              ...
              <div className="details__card-content">
                <h2 className="header header--secondary">
                  <span className="body body--display details__number">3.</span> Meet up
                </h2>
      ...
      <section className="groups-section">
        <div className="groups-section__curve-divider">
          <svg className="groups-section__curve-shape" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path
